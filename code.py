...
if __name__ == '__main__':
    dbb1 = kelas("localhost", "3306", "root", "")
    dbb1.create_db("Scoring")
    df = dbb1.import_csv(r"C:\Users\USER\Desktop\Temp\scoring.csv")
    dbb1.create_table("Scoring", "ITClass", df)
    print(dbb1.load_data("Scoring", "ITClass"))
